            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Numero de téléphone') }}</label>

                            <div class="col-md-6">
                                <input id="numerotelephone" type="number" class="form-control @error('numerotelephone') is-invalid @enderror" name="numerotelephone" value="{{ old('numerotelephone') }}" required autocomplete="numerotelephone" autofocus>
